    ...
    def __init__(self, opt):
        ...
        if self.tf_log:
            ...
            if int(tf.__version__[0]) == 2:
                self.writer = tf.compat.v1.summary.FileWriter(self.log_dir) # │AttributeError: module 'tensorboard.summary._tf.summary' has no attribute 'FileWriter'
                # eager mode がcompativleじゃないとか
            else:
