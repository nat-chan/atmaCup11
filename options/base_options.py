...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--df_csv', type=str, default='train.csv', help='dataframe csv file name')
        parser.add_argument('--dirs', type=str, default='photos,photos_h,photos_v,photos_r,photos_hv,photos_hr,photos_vr,photos_hvr', help='phots in datarooot directories')
